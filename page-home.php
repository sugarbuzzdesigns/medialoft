...
<?php get_header(); ?>
	<section id="home-landing">
		...
		<div class="video-bg-container">
			<video muted controls preload="auto" id="home-video-loop" class="video-js vjs-default-skin" loop autoplay data-setup='{}'>
		...
		<div id="home-video-overlay" class="video-overlay">
			<video id="home-video-full" class="video-js vjs-default-skin" controls data-setup='{}'>
