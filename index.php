...
<section id="blog">
  <div class="articles group">
    <?php $blog_posts = query_posts(array('orderby'=>'date','order'=>'DESC')); ?>
    <?php
				$num_posts = count($blog_posts);
				$oddNumPosts = $num_posts % 2 == 1 ? true : false;
			?>
    ...
    ?>
    <article id="<?php echo seoUrl(get_the_title()); ?>" class="collapsed blog-article no-related-articles">
        ...
        <div class="inner">
          <div class="header-copy">
            <div class="<?php echo $article_headline_class; ?>">
              ...
              <div class="video-start play-full-screen" data-video="<?php echo seoUrl(get_the_title()); ?>-video"
                data-video-src="<?php echo $videoUrl; ?>">
                <div></div>
                <div></div>
              </div>
              <?php } ?>
            ...
            <div class="info">
              ...
              <!-- / <span class="date"><?php //echo get_formatted_date(get_the_date('m-d-y')); ?> -->
      ...
      <div class="article-content">
        ...
        <div class="social">
          ...
          <a class="twitter" data-url="<?php the_permalink(); ?>"
      ...
      <div class="related-articles">
        ...
        <a href="#" data-related-article="<?php echo seoUrl(get_the_title()); ?>" class="related-article blog-article"
