(function($){
	...
	ml.Timeline = {
		...
		loopEvents: function(containerIndex, numBoxes, isLast){
			...
			var hyp = Math.sqrt(Math.pow(this.squareSideLength, 2) + Math.pow(this.squareSideLength, 2));

			var leftAdjustment = (hyp - this.squareSideLength) / 2;

			var cLeft = containerIndex * (sqRoot*3) + 40 + leftAdjustment;
