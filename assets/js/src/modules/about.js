...
;(function ($) {
  ...
  $(function () {
    ...
    $("section").snapPoint({
      ...
      outerTopOffset: $(window).height() * 0.4, // Number of pixels for the downward vertical offset (relative to the top of your snapping container)
      innerTopOffset: $(window).height() * 0.4, // Number of pixels for the upward vertical offset (relative to the top of your snapping container)
    })
      ...
      swipe: function (event, direction, distance, duration, fingerCount) {
        if (direction === "up") {
          if (
            ...
            ml.About.Global.sectionsCount - 1
          ) {
            return
          }
          ml.About.Global.currentIndex++
        ...
        if (direction === "down") {
          // console.log('down');
          if (ml.About.Global.currentIndex === 0) {
            return
          }
          ml.About.Global.currentIndex--
