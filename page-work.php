  ...
  <div id="work-items" class="work-items">
    <?php foreach ($workItems as $workItem) { ?>
      <?php if (!is_user_logged_in()) {
        if ($workItem['company name'] === 'Optum') {
          continue;
        }
      }
      ?>
                ...
                <div class="carousel-item">
                  ...
                  <div class="work-media">
                    <?php if ($slide['media'][0] == 'image') { ?>
                      ...
                      <?php } ?>
                    <?php } else { ?>
                      <div class="video-bg-container <?php if (wp_is_mobile()) {
                                                        echo 'mobile';
                                                      } ?>">
                        ...
                        <?php } else { ?>
                          <video class="work-video work-full-video video-js vjs-default-skin mobile-work-full-video" data-src="<?php echo $slide['media-mobile'][0]; ?>">
                          </video>
                        <?php } ?>
